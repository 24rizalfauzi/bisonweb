...
const routes = [
    ...
    {
        path: 'gangguan',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-gangguan-gangguan-module */ "pages-gangguan-gangguan-module").then(__webpack_require__.bind(null, /*! ./pages/gangguan/gangguan.module */ "./src/app/pages/gangguan/gangguan.module.ts")).then(m => m.GangguanPageModule)
    },
    {
        path: 'ide',
...
/* harmony import */ var _ionic_native_background_mode_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/background-mode/ngx */ "./node_modules/@ionic-native/background-mode/ngx/index.js");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, location, apiService, fcm, backgroundMode, loadingController
    ...
    initializeApp() {
        ...
        this.platform.ready().then(() => {
            ...
            if (this.user != null) {
                this.apiService.postData('countNotif', { activeUserId: this.user.id, userId: this.user.id }).subscribe((result) => {
                ...
                if (platformName != "") {
                    ...
                    this.fcm.getToken().then(token => this.apiService.postData('updateTokenFirebase', { activeUserId: this.user.id, userId: this.user.id, tokenFirebase: token }).subscribe()).catch(error => console.log(error)
                    ...
                    this.fcm.onTokenRefresh().subscribe((token) => this.apiService.postData('updateTokenFirebase', { activeUserId: this.user.id, userId: this.user.id, tokenFirebase: token }).subscribe());
                }
...
let ApiService = class ApiService {
    constructor(http, storage, config, alertController) {
        this.http = http;
    ...
    postData(destinationApi, inputData) {
        const urlsend = this.config.serverUrl + `/api/` + destinationApi;
        var data = this.http.post(urlsend, inputData, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', localStorage.getItem('token')) });
        return data;
    }
    gangguan(err) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
ApiService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_3__["NativeStorage"], src_app_services_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"]])
], ApiService);
...
let ConfigService = class ConfigService {
    ...
    constructor() {
        ...
        this.serverUrl = 'https://192.168.108.6:8512';
    }
};
...
module.exports = __webpack_require__(/*! E:\EP\BISONDOCS\BaliSmartInnovation\src\main.ts */"./src/main.ts");
