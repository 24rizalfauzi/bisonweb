...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-ebook-ebook-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesEbookEbookPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesEbookEbookRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    EbookPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesEbookEbookModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ebook_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./ebook-routing.module */
    "./src/app/pages/ebook/ebook-routing.module.ts");
    /* harmony import */


    var _ebook_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./ebook.page */
    "./src/app/pages/ebook/ebook.page.ts");
    ...
    EbookPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ebook_routing_module__WEBPACK_IMPORTED_MODULE_6__["EbookPageRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{
        path: '',
        component: _ebook_page__WEBPACK_IMPORTED_MODULE_7__["EbookPage"]
      }])],
  ...
  /***/
  function srcAppPagesEbookEbookPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesEbookEbookPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var EbookPage = /*#__PURE__*/function () {
      function EbookPage(http, apiService, config) {
      ...
      _createClass(EbookPage, [{
        ...
        key: "getPageEbook",
        value: function getPageEbook() {
          var _this = this;

          this.apiService.postData('getPageEbook', {
            activeUserId: this.user.id
          }).subscribe(function (result) {
            if (result.responseCode == true) {
              _this.ebooks = result.ebooks;
        ...
        value: function downloadAttachment(ebookName) {
          window.open(this.config.serverUrl + "/api/downloadEbook/" + ebookName, '_self');
        }
      }, {
        key: "uploadEbook",
        value: function uploadEbook(form) {
          var _this2 = this;
          ...
          if (validForm) {
            ...
            this.apiService.postData('uploadEbook', inputData).subscribe(function (result) {
              console.log(result);

              if (result.responseCode == false) {
                _this2.msgUploadEbook = result.responseMessage;
                document.getElementById('stlMsgUploadEbook').style.color = 'red';
              } else if (result.responseCode == true) {
                _this2.attachments = undefined;
                _this2.folder = undefined;
        ...
        key: "onChangeFolderList",
        value: function onChangeFolderList(folderName) {
    ...
    EbookPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-ebook',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./ebook.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/ebook/ebook.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./ebook.page.scss */
      "./src/app/pages/ebook/ebook.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], src_app_services_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"]])], EbookPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-ebook-ebook-module-es5.js.map