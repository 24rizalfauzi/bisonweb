...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesModalAddUsersModalAddUsersPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesModalAddUsersModalAddUsersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ModalAddUsersPageRoutingModule", function () {
      return ModalAddUsersPageRoutingModule;
    });
    /* harmony import */
    ...
    var _modal_add_users_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./modal-add-users.page */
    ...
    var ModalAddUsersPageRoutingModule = function ModalAddUsersPageRoutingModule() {
      _classCallCheck(this, ModalAddUsersPageRoutingModule);
    };

    ModalAddUsersPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesModalAddUsersModalAddUsersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ModalAddUsersPageModule", function () {
      return ModalAddUsersPageModule;
    });
    /* harmony import */
    ...
    var _modal_add_users_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./modal-add-users-routing.module */
    "./src/app/pages/modal-add-users/modal-add-users-routing.module.ts");
    /* harmony import */


    var _modal_add_users_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./modal-add-users.page */
    "./src/app/pages/modal-add-users/modal-add-users.page.ts");

    var ModalAddUsersPageModule = function ModalAddUsersPageModule() {
      _classCallCheck(this, ModalAddUsersPageModule);
    };

    ModalAddUsersPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _modal_add_users_routing_module__WEBPACK_IMPORTED_MODULE_5__["ModalAddUsersPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesModalAddUsersModalAddUsersPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesModalAddUsersModalAddUsersPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ModalAddUsersPage", function () {
      return ModalAddUsersPage;
    });
    /* harmony import */
    ...
    var ModalAddUsersPage = /*#__PURE__*/function () {
      function ModalAddUsersPage(activatedRoute, apiService, config) {
        _classCallCheck(this, ModalAddUsersPage);
      ...
      _createClass(ModalAddUsersPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.readParams();
        }
        ...
        value: function readParams() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            _this.modalName = params['modalName'];
            _this.id = params['id'];
            _this.userfor = params['userfor'];
        ...
        value: function getPegawai() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            var inputDataGetPeg = {
              activeUserId: _this2.user
            };

            _this2.apiService.postData('getPagePegawai', inputDataGetPeg).subscribe(function (result) {
              if (result.responseCode == true) {
                _this2.pegawaisource = result.pegawai;
                _this2.pegawaishow = result.pegawai;
              }
            }, function (err) {
        ...
        value: function getMember() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            if (_this3.userfor == 'ide') {
              var inputDataGetMem = {
                activeUserId: _this3.user.id,
                ideId: _this3.id
              };

              _this3.apiService.postData('getPageForumIde', inputDataGetMem).subscribe(function (result) {
                if (result.responseCode == true) {
                  _this3.memberId = result.ide.memberId;
                  _this3.memberName = result.ide.memberName;
                  _this3.applicantId = result.ide.applicantId;
                  _this3.mentorId = result.ide.mentorId;

                  var arrMemberId = _this3.memberId.split(",");

                  console.log(arrMemberId);
                  console.log(_this3.pegawaisource);

                  for (var i = 0; i < _this3.pegawaisource.length; i++) {
                    for (var j = 0; j < arrMemberId.length; j++) {
                      if (_this3.pegawaisource[i].id == arrMemberId[j]) {
                        _this3.pegawaisource[i].checked = true;
                        _this3.pegawaishow[i].checked = true;
                      }
                    }
                  }
                }
            ...
            } else if (_this3.userfor == 'sharing') {
              var inputDataGetShar = {
                activeUserId: _this3.user.id,
                sharingId: _this3.id
              };

              _this3.apiService.postData('getPageForumSharing', inputDataGetShar).subscribe(function (result) {
                if (result.responseCode == true) {
                  _this3.memberId = result.sharing.memberId;
                  _this3.memberName = result.sharing.memberName;
                  _this3.applicantId = result.sharing.applicantId;
                  _this3.mentorId = result.sharing.mentorId;
        ...
        key: "submitAddUsers",
        value: function submitAddUsers() {
          var _this4 = this;

          //const profileForm = new FormData()
          this.userchecked = this.pegawaishow.filter(function (item) {
          ...
          if (this.userfor == 'ide') {
            ...
            this.apiService.postData('updateMembersIde', inputDataSubmIde).subscribe(function (result) {
              if (result.responseCode == false) {} else if (result.responseCode == true) {
                _this4.members = result.members;
                window.location.href = '/tabs/forum-ide?ideId=' + _this4.id;
              }
            }, function (err) {
              console.log(err);
            });
            ...
            this.apiService.postData('updateMembersSharing', inputDataSubmShar).subscribe(function (result) {
              if (result.responseCode == false) {} else if (result.responseCode == true) {
                _this4.members = result.members;
                window.location.href = '/tabs/forum-sharing-session?ideId=' + _this4.id;
              }
            }, function (err) {
              console.log(err);
            });
        ...
        value: function onChangeSearch(event) {
          ...
          if (val && val.trim() != '') {
            this.pegawaishow = this.pegawaisource.filter(function (item) {
    ...
    ModalAddUsersPage.ctorParameters = function () {
      return [{
    ...
    ModalAddUsersPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-modal-add-users',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./modal-add-users.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/modal-add-users/modal-add-users.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./modal-add-users.page.scss */
      "./src/app/pages/modal-add-users/modal-add-users.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], src_app_services_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"]])], ModalAddUsersPage);
    /***/
  },
  ...
  function srcAppPagesModalModalModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modal_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./modal-routing.module */
    "./src/app/pages/modal/modal-routing.module.ts");
    /* harmony import */


    var _modal_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./modal.page */
    "./src/app/pages/modal/modal.page.ts");
    ...
    ModalPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _modal_routing_module__WEBPACK_IMPORTED_MODULE_6__["ModalPageRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{
        path: '',
        component: _modal_page__WEBPACK_IMPORTED_MODULE_7__["ModalPage"]
      }])],
  ...
  function srcAppPagesModalModalPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ModalPage = /*#__PURE__*/function () {
      function ModalPage(activatedRoute, apiService, config) {
      ...
      _createClass(ModalPage, [{
        ...
        value: function readParams() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            _this5.modalName = params['modalName'];
            _this5.userId = params['userId'];
            var inputData = {
              activeUserId: _this5.user.id,
              userId: params['userId']
            };

            _this5.apiService.postData('getUserById', inputData).subscribe(function (result) {
              console.log(result);

              if (result.responseCode == false) {
                console.log(result.responseCode);
              } else if (result.responseCode == true) {
                _this5.userNip = result.user.nip;
                _this5.userName = result.user.name;
                _this5.userRole = result.user.role;
                _this5.userStatus = result.user.status;
                _this5.userEmail = result.user.email;
                _this5.userPhoto = _this5.config.serverUrl + "/assets/profile-pics/" + result.user.photo;
              }
            }, function (err) {
        ...
        key: "submitUpdateProfile",
        value: function submitUpdateProfile(form) {
          var _this6 = this;
          ...
          this.apiService.postData('updateUser', profileForm).subscribe(function (result) {
            if (result.responseCode == false) {
              console.log(result);
            } else if (result.responseCode == true) {
              window.open('/tabs/profile?userId=' + _this6.userId, '_self');
            }
          }, function (err) {
            _this6.apiService.gangguan(err);
          });
        }
      }, {
        key: "getFiles",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], src_app_services_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"]])], ModalPage);
    /***/
  }
}]);
